            ...
            <div class="col-md-4 mr-auto">
              <div class="card card-signup text-center">
                <div class="card-header ">
                  <h4 class="card-title">註冊表單</h4>
                  <div class="social">
                    <button class="btn btn-icon btn-round btn-twitter">
                      <i class="fab fa-twitter"></i>
                    </button>
                    <button class="btn btn-icon btn-round btn-google" type="button" onclick="location.href='${pageContext.request.contextPath}/oauth2/authorization/google'" />
                ...
                <div class="card-body ">
                  <form class="form" method="POST" action="${pageContext.request.contextPath}/memberregister"  onclick="checkUsername();checkEmail()" >
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="帳號" class="form-control" name="username" id="username">
                    </div>
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <div class="input-group-text">
                      ...
                      <input type="password" placeholder="密碼" class="form-control" name="password">
                    </div>
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="信箱" name="email" id="email">
                    </div>
                     ...
                     <div class="input-group">
                      ...
                      <input type="text" placeholder="地址" class="form-control" name="address" id="address">
                    </div>
                    

                    <button type="submit" class="btn btn-primary btn-round btn-lg"  id="submit">提交</button>
                    <div id="msg"></div>
                    <div id="msg2"></div>
                  </form>
                </div>
...
<!--   <script src="${pageContext.request.contextPath}/js/now-ui-dashboard.min.js?v=1.6.0" type="text/javascript"></script>Now Ui Dashboard DEMO methods, don't include it in your project! -->
 ...
 <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
	...
	function checkUsername(){
	  ...
	  axios.post(`${pageContext.request.contextPath}/checkUsername/\${username}`)
	  .then((res) =>{
	       console.log("RESPONESE" , res.data)
	      if(res.data == true){
	          my("msg").innerHTML = "您輸入的帳號已被使用";
	          my("msg").style.color = "red";
	          my("submit").style.display="none";
	      };
	      if(res.data == false){
	      document.getElementById("msg").innerHTML = "你可以使用這個帳號 !";
	      document.getElementById("msg").style.color = "green";
          my("submit").style.display="inline";
	...
	function checkEmail(){
	    ...
	    axios.post(`${pageContext.request.contextPath}/checkEmail/\${email}`)
	    .then((res2)=>{
	       if(res2.data == true){
	          my("msg2").innerHTML = "您輸入的信箱已被使用";
	          my("msg2").style.color = "red";
	          my("submit").style.display="none";
	       };
	      if(res2.data == false){
	          my("msg2").innerHTML = "你可以使用這個信箱 !";
	          my("msg2").style.color = "green";
	          my("submit").removeAttribute('style');
