...
<!-- ============================================================ -->
	  <div class="panel-header panel-header-sm">  <!-- 上面背景牆 -->
		...
		<form action="${pageContext.request.contextPath}/users/updatePassword" method="POST" name="userForm" onSubmit="return validateForm()" enctype="multipart/form-data">
				...
				<fieldset class="form-group">
					<label>密碼</label> <input type="password"
						...
						name="password" id="password" minlength="1">
				</fieldset>
				
				<fieldset class="form-group">
					<label>請再次輸入密碼</label> <input type="password"
						 class="form-control" required autofocus
						name="confirmPassword" minlength="1"  oninput=checkPasswordMatch(this) >
				</fieldset>
