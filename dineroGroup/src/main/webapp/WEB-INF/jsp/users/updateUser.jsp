...
<!-- ============================================================ -->
  ...
  <input type="hidden" name="userId" value="${User.userId}" />                <!--        You can switch " data-color="primary" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                      ...
                      <div class="row justify-content-center">
                        <div class="col-sm-4">
                          <div class="picture-container">
							...
							<img src="<c:out value="${User.photoImagePath}"/>" id="thumbnail" alt=""/>
                              	<input type="file" value="<c:out value="${User.photoImagePath}"/>"  name="fileImage" id="fileImage"  accept="image/png , image/jpeg , image/jpg ">	
...
<script>
 ...
 document.getElementById("oneInput").addEventListener("click" , function(){
 	...
 	username.value = "tom40961";
 	password.value = "kevin123";    
 	name.value = "王大明";
 	email.value="tom40961@gmail.com" ;
