      ...
      <div class="content">
        <div class="container">
          <div class="col-md-4 ml-auto mr-auto">
            ...
            <form:form class="form" method="post" action="${pageContext.request.contextPath}/forgotPassword">
		...
		<p class = "text-success">${message}</p>
                ...
                <div class="card-body ">
                  <div class="input-group no-border form-control-lg">
                    ...
                    <input type="text" name="email" placeholder="請輸入您的信箱" class="form-control">
                  </div>
                </div>
